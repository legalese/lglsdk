...
print("if [ -n \"$onoes\" ]; then count=`cat $testdir/failures-*.txt | wc -l`; echo \"!!! $count tests failed! $onoes\"; ls -l $testdir/failures-*.txt; echo ""; cat $testdir/failures-*.txt; else echo \"*** all tests passed!\"; fi");
#+END_SRC
